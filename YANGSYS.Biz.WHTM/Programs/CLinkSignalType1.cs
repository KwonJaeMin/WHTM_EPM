...
{
    public class CLinkSignalType1 : AProgram
    {
        //BC
        ...
        private int InnerExecute()
        {
            ...
            while (true)
            {
                ...
                bool upstreamOn = _main.MelsecNetBitRead(IB_LINK_UP_UPSTREAM_INLINE, 1);
                
                switch (_step)
                {
                    case enmuStep.NONE:
                        if (downstreamOn && upstreamOn && stageExchangePossible == false && _component.LoadRequest )
                        {
                    ...
                    case enmuStep.WAIT:
                        ...
                        {
                            _step = enmuStep.DATA_CHECK;
                        }
                        break;
                    case enmuStep.DATA_CHECK:
                        //job data read
                        ...
                        _main.AddReceviedGlassData(_component.ControlName, glassData);
                    ...
                    case enmuStep.WAIT_START:
                        ...
                        break;
                    case enmuStep.START:
                        if (_main.MelsecNetBitRead(IB_LINK_UP_SEND_START, 1))
                        {
                    ...
                    case enmuStep.MOVING:
                        ...
                        //if (_main.MelsecNetBitRead(IB_LINK_UP_JOB_TRANSFER_SIGNAL, 1))
                        //{
                        ...
                        //}
                        //else if(_main.MelsecNetBitRead(IB_LINK_UP_CANCEL_REQUEST, 1))
                        //{
                        //    _main.MelsecNetBitOnOff(OB_LINK_DOWN1_CANCEL_ACK, true);
                        ...
                        if (_main.MelsecNetBitRead(IB_LINK_UP_JOB_TRANSFER_SIGNAL, 1))
                        {
                            ...
                            if (glassData != null)
                            {
                                ...
                                _main.MelsecNetMultiWordWrite(OW_RECEIVED_JOB_DATA1, value1);
                            }
                    ...
                    case enmuStep.CANCEL:
                        if (_main.MelsecNetBitRead(IB_LINK_UP_CANCEL_REQUEST, 1) == false)
                        {
                            _main.MelsecNetBitOnOff(OB_LINK_DOWN1_RECEIVE_ABLE, false);
                            _main.MelsecNetBitOnOff(OB_LINK_DOWN1_RECEIVE_START, false);
                            _main.MelsecNetBitOnOff(OB_LINK_DOWN1_CANCEL_ACK, false);
                            _step = enmuStep.NONE;
                    ...
                    case enmuStep.COMPLETE:
                        ...
                        if (_main.MelsecNetBitRead(IB_LINK_UP_SEND_COMPLETE, 1) == false)
                        {
                            ...
                            _step = enmuStep.REPORT;
                        }

                        break;
                    case enmuStep.REPORT:
