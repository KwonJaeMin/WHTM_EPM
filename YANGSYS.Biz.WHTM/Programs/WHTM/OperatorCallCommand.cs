...
namespace YANGSYS.Biz.Programs
{
    ...
    public class OperatorCallCommand : AProgram
    {
        private CMain _main = null;
        private bool _enable = false;

        //BC        
        private CScanControlProperties IB_OPERATOR_CALL = null;//SD_B_OperatorCall_BCToL3
        ...
        private CPLCControlProperties OB_OPERATOR_CALL = null;//SD_B_OperatorCall_BCToL3
        ...
        public override int Init()
        {
            ...
            //BC
            IB_OPERATOR_CALL = _main.SCANCONTEROLS.GetProperty(_controlName, "IB_OPERATOR_CALL");
            ...
            //PROBE CIM
            OB_OPERATOR_CALL = _main.PLCCONTEROLS.GetProperty(_controlName, "OB_OPERATOR_CALL");
        ...
        protected override int InnerExecute()
        {
            ...
            _main.MelsecNetBitOnOff(OB_OPERATOR_CALL, false);
