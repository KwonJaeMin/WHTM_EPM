...
namespace YANGSYS.Biz.Programs
{
    public class CLinkSignalType10 : AProgram
    {
        ...
        private enmuStep _previousStep = enmuStep.NONE;
            ...
            while (true)
            {
                ...
                switch (_step)
                {
                    ...
                    case enmuStep.MOVING:
                        ...
                        //    _step = enmuStep.WAIT_RECV_COMPLETE;
                        //}
                    ...
                    case enmuStep.CANCEL:
                        ...
                        break;
                    case enmuStep.WAIT_RECV_COMPLETE:
                        ...
                        if (_main.MelsecNetBitRead(IB_LINK_DOWN_RECEIVE_COMPLETE, 1))
                        {
                            ...
                            _step = enmuStep.RECV_COMPLETE;
                        }
                        break;
                    case enmuStep.RECV_COMPLETE:
                        ...
                        if (_main.MelsecNetBitRead(IB_LINK_DOWN_RECEIVE_ABLE, 1) == false)
                            if (_main.MelsecNetBitRead(IB_LINK_DOWN_RECEIVE_START, 1) == false)
                                if (_main.MelsecNetBitRead(IB_LINK_DOWN_RECEIVE_COMPLETE, 1) == false)
                                {
                                    ...
                                    _step = enmuStep.WAIT_SEND_COMPLETE;
                                }

                        break;
                    case enmuStep.WAIT_SEND_COMPLETE:
                        ...
                        if (_main.MelsecNetBitRead(IB_LINK_UP_SEND_COMPLETE, 1))
                        {
                            ...
                            _step = enmuStep.SEND_COMPLETE;
                        }
                        break;
                    case enmuStep.SEND_COMPLETE:
