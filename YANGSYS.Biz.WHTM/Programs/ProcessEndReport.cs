...
namespace YANGSYS.Biz.Programs
{
    ...
    public class ProcessEndReport : AProgram
    {
        private CMain _main = null;
        private bool _enable = false;

        //BC
        private CScanControlProperties IB_GLASS_PROCESS_END_REPORT_REPLY = null;

        //PROBE CIM
        private CPLCControlProperties OB_GLASS_PROCESS_START_REPORT = null;
        private CPLCControlProperties OW_GLS_PROCESS_END_GLASS_CODE = null;
        private CPLCControlProperties OW_GLS_PROCESS_END_UNIT_NO = null;
        ...
        public override int Init()
        {
            ...
            IB_GLASS_PROCESS_END_REPORT_REPLY = _main.SCANCONTEROLS.GetProperty(_controlName, "IB_GLASS_PROCESS_END_REPORT_REPLY");

            OB_GLASS_PROCESS_START_REPORT = _main.PLCCONTEROLS.GetProperty(_controlName, "OB_GLASS_PROCESS_START_REPORT");
            OW_GLS_PROCESS_END_GLASS_CODE = _main.PLCCONTEROLS.GetProperty(_controlName, "OW_GLS_PROCESS_END_GLASS_CODE");
            OW_GLS_PROCESS_END_UNIT_NO = _main.PLCCONTEROLS.GetProperty(_controlName, "OW_GLS_PROCESS_END_UNIT_NO");
